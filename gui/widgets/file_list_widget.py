...
from utils.list_utils import loadlist, save_list_to_file
import os
import platform
import subprocess
...
class ListGUI(QWidget):
    ...
    def list_commands(self):
        ...
        paste_action = QAction(qta.icon('mdi.content-paste'), 'Paste the system clipboard to the list', self)
    ...
    def freeze(self, bool):
        # Keep toolbar enabled - users should still be able to delete, save, sort, etc.
        # Only disable drag-and-drop and item reordering
        # self.tb.setEnabled(not bool)  # Removed: toolbar should always be enabled
