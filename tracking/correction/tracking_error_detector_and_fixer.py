...
This module detects and fixes common tracking errors including:
- Cell ID swapping between frames
- Missing cell assignments
- Incorrect neighbor associations
- Vertex detection and validation
"""
