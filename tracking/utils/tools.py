...
This module provides utility functions for cell tracking including:
- File path management for tracking outputs
- Name parsing and file organization
- Helper functions for tracking algorithms
"""
