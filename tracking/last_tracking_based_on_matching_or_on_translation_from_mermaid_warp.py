"""Static tissue tracking based on maximum overlap matching.

This module implements cell tracking for static tissues by matching cells between
consecutive time frames based on maximum overlap. Supports image registration
and optional Mermaid warping for improved tracking accuracy.
"""
...
from tracking.registration import pre_register_images, apply_translation
from tracking.tools import assign_random_ID_to_missing_cells, get_TA_file, get_mask_file, first_image_tracking
