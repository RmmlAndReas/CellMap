"""Rapid vertex detection for cell-cell junctions.

This module detects vertices (cell-cell junctions) in segmented images
and associates them with cells and their neighbors.
"""
