...
from database.sql_column_name_dialog import SQL_column_name_and_type
from utils.list_utils import loadlist, smart_TA_list
from database.my_qt_table import MyTableWidget
from database.sqlite_db import TAsql, get_properties_master_db, \
