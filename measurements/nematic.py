"""Nematic tensor calculations for cell orientation analysis.

This module computes nematic tensors to quantify cell orientation and alignment
in epithelial tissues. Used for analyzing tissue anisotropy and cell polarity.
"""
...
from gui.shapes.line2d import Line2D
...
class Nematic():
    ...
    def __init__(self, S1S2=None, S1=None, S2=None, S0=None, angle=None, base=None, tip=None,
        ...
        if base is not None and tip is not None:
            # print('init',base, tip)
            from measurements.cell_properties import distance_between_points
...
if __name__ == "__main__":
    ...
    if True:
        ...
        from measurements.TAmeasures import distance_between_points
