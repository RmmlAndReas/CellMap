"""3D measurements for cell properties.

This module computes 3D measurements including surface area, perimeter,
and volume from triangulated cell surfaces and height maps.
"""
