"""CellMap utility functions.

This module provides utility functions for file naming, path management,
and common operations used throughout the CellMap package.
"""
