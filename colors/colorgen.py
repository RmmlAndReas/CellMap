"""Color generation utilities for cell tracking.

This module provides functions to generate unique random colors for cell IDs
in tracking, ensuring no color collisions occur.
"""
